...
function mapDocToUserData(uid, profileDoc = {}, fallbackEmail = "") {
  ...
  return {
    ...
    category: profileDoc.categoria || "9na (Iniciantes)",
    ...
    plan: profileDoc.plan || null,
    planStatus: profileDoc.planStatus || "none",
    planExpiresAt: profileDoc.planExpiresAt || null,
    trialEndDate: profileDoc.trialEndDate || null,
    planActivatedDate: profileDoc.planActivatedDate || null,
